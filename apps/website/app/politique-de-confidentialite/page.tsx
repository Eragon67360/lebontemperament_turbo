    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <section className="bg-white shadow-md rounded-lg p-6 mb-6">
          <h2 className="text-lg xl:text-2xl font-semibold mb-4">
            Introduction
          </h2>
          <p className="mb-4">
        ...
        <section className="bg-white shadow-md rounded-lg p-6 mb-6">
          ...
          <p className="mb-4">
            ...
            tiers. Nous pouvons partager vos informations avec des fournisseurs
            de services tiers pour faciliter notre service, fournir le service
            en notre nom, ou nous aider à analyser l&apos;utilisation de notre
            service.
          </p>
        </section>
        <section className="bg-white shadow-md rounded-lg p-6">
          ...
          <p className="mb-4">
            ...
            informations personnelles que nous avons sur vous. Si vous souhaitez
