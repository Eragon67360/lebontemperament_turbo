...
const page = () => {
    return (
        <div className=' mx-8 max-w-[1440px] w-full flex flex-col pb-8'>
            <div className='py-16'>
                <div >
                    <h1 className='text-title text-primary/50 font-light leading-none'>Concerts</h1>
