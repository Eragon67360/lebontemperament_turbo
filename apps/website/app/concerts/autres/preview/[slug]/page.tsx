...
export default function Preview() {
        ...
        return (
            <>
                <div className='flex flex-col justify-center items-center'>
                    <h2 className='font-bold text-xl'> Les données de ce CD n&apos;ont pas pu être trouvées, nous en sommes désolés</h2>
                    <Link href={'/concerts/autres'} className='bg-primary text-white'>Voir tous les CDs</Link>
                </div>
            </>
        );
    }
    return (
        ...
        <div className="container mx-auto pt-8 my-8 space-y-8 h-full">
            ...
            <h1 className="text-xl md:text-3xl lg:text-5xl font-bold mb-4 mx-auto text-center">{cd.title} | Le Bon Tempérament</h1>

            <div className="flex flex-col lg:flex-row gap-8 h-full">
                <CloudinaryImage src={cd.image} alt={cd.title} className="h-[300px] md:h-[400px] lg:h-[600px] object-cover mb-4 mx-auto border border-black" width={1000} height={400} rounded={RoundedSize.NONE} />
                ...
                <div className='flex flex-col gap-4 justify-between h-full lg:h-[600px] w-full px-8 lg:px-0'>
                    <div className='flex flex-col gap-4'>
                        ...
                        <p className="mb-4"><strong>Date de sortie:</strong> {cd.releaseDate}</p>
