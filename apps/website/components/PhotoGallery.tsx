...
export default function PhotoGallery() {
    ...
    return (
        <>
            <Accordion>
                <AccordionItem key="1" aria-label="Nos concerts" title={<p className='text-xl md:text-2xl lg:text-4xl'>Nos concerts</p>} className='font-bold text-xl md:text-2xl lg:text-4xl'>
                    <MasonryPhotoAlbum
                        columns={columns}
                ...
                <AccordionItem key="2" aria-label="La vie au BT" title={<p className='text-xl md:text-2xl lg:text-4xl'>La vie au BT</p>} className='font-bold text-xl md:text-2xl lg:text-4xl'>
                    <MasonryPhotoAlbum
                        columns={columns}
                        photos={imagesVieBT}
