  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <motion.div
        ...
        className="text-7xl hyphens-auto font-extrabold bg-gradient-to-r from-primary via-white/50 to-purple-500 inline-block text-transparent bg-clip-text"
      >
        Bienvenue,{" "}
        <motion.span
          initial={{ opacity: 0 }}
      ...
      >
        ...
        <b>Bon Tempérament</b>.<br /> Tu trouveras ci-dessous les liens les plus
        utiles...
      </motion.div>
      ...
      <motion.div
        ...
        className="mx-auto relative mt-16"
      >
        <Image
          src={"/img/violin.webp"}
          alt="violin"
          width={300}
          height={200}
          className="w-[300px] md:w-[400px] lg:w-7xl opacity-20"
          style={{
            height: "auto",
            maskImage:
        ...
        />
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full absolute top-0 left-0">
