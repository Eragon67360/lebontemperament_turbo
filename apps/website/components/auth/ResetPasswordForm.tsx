    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success("C'est parti !", {
                description: "Un email magique vient de s'envoler vers ta boîte mail 🪄"
            })
            ...
            <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center gap-2 text-center">
                    ...
                    <p className="text-balance text-sm text-muted-foreground">
                        File vite checker ta boîte mail, un message t&apos;attend pour récupérer ton accès !
                    </p>
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-balance text-sm text-muted-foreground">
                    Pas de panique ! Donne-nous ton email et on t&apos;aide à retrouver tes accès 🔑
                </p>
            </div>
