...
const Gazette = () => {
  ...
  return (
    <div
      className="mt-8 rounded-3xl relative w-full h-64 overflow-hidden transition duration-300 cursor-pointer"
      ...
      {isHovered && (
        <div className="absolute inset-0 bg-black/70 flex flex-col lg:flex-row justify-evenly items-center py-4 transition duration-300">
          <Link
            ...
            target="_blank"
            rel="noopener"
            className="bg-white text-black border border-black p-4 flex gap-2 items-center hover:border-black/50 hover:text-black/50 transition"
          >
