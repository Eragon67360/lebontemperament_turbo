...
export default function UsersPage() {
    ...
    const [editingUser, setEditingUser] = useState<{ id: string; display_name: string } | null>(null);
    ...
    const inviteCounts = users.reduce((acc, user) => {
    ...
    const handleRoleChange = async (userId: string, newRole: 'user' | 'admin') => {
        try {
            ...
            if (userToUpdate?.role === 'superadmin') {
                toast.error("Action non autorisée", {
                    description: "Impossible de modifier le rôle d'un super administrateur."
                });
                return;
            }
