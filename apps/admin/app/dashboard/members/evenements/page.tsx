...
export default function Evenements() {
    ...
    const handleCreate = async (e: React.FormEvent<HTMLFormElement>, dateFrom: Date | undefined, dateTo: Date | null | undefined) => {
        e.preventDefault()
        setLoading(true)
    ...
    const handleEdit = async (e: React.FormEvent<HTMLFormElement>, dateFrom: Date | undefined, dateTo: Date | null | undefined) => {
        e.preventDefault()
        setLoading(true)
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6 mb-8">
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                    ...
                    <DialogContent className="sm:max-w-[425px] md:max-w-[600px]">
                        <DialogHeader>
                            <DialogTitle className="text-lg md:text-xl">Ajouter un nouvel événement</DialogTitle>
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-1">
                                            ...
                                            <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                ...
                                                <span>
                                                    {formatEventDate(event)} à {event.time.slice(0, 5).replace(':', 'h')}
                                                </span>
                                            </div>
                                        </div>
