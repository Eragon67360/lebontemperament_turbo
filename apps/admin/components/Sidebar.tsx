                                ...
                                subroute.visible !== false && (
                                    <Link
                                        ...
                                        className={cn(
                                            ...
                                            pathname === subroute.href && "bg-primary/10 text-primary"
                                        )}
                                    >
            ...
            {user && (
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className='flex h-fit gap-2 mt-auto py-2 mx-3 hover:bg-primary/10 hover:text-primary'>
