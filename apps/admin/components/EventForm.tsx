...
interface EventFormProps {
    onSubmit: (e: React.FormEvent<HTMLFormElement>, dateFrom: Date | undefined, dateTo: Date | undefined) => Promise<void>
    loading: boolean
    initialData?: Event | null
    submitLabel: string
}

export function EventForm({ onSubmit, loading, initialData, submitLabel }: EventFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                    <Label htmlFor="responsible_email">Email du responsable (optionnel)</Label>
                    <Input
            ...
            <div>
                ...
                <Select name="event_type" required defaultValue={initialData?.event_type || 'autre'}>
                    <SelectTrigger>
            ...
            <div>
                <Label htmlFor="description">Lien de l&apos;évènement (optionnel)</Label>
                <Input
                    id="link"
                    name="link"
            ...
            <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                    Si coché, l&apos;événement sera visible sur le site public. Sinon, il ne sera visible que pour les membres.
                </p>
            </div>
