...
import { ChevronRight, Globe, LogOut, LucideIcon, Menu, Settings, Users } from 'lucide-react';
...
export function NavigationMenuDashboard() {
    ...
    const [workNavigation, setWorkNavigation] = useState<WorkNavigation | null>(null);
    ...
    const navItems: NavItem[] = [
        {
            title: 'Site Public',
            description: 'Gérez et personnalisez le contenu visible par le grand public',
            icon: Globe,
            url: RouteNames.DASHBOARD.PUBLIC.ROOT,
            items: [
                {
                    title: "Page d'accueil",
                    description: 'Configurez et personnalisez les éléments de la page d\'accueil',
                    url: RouteNames.DASHBOARD.PUBLIC.HOME.ROOT,
                    items: [
                        {
                            title: 'Projets',
                            description: 'Gérez et présentez vos projets artistiques et musicaux',
                            url: RouteNames.DASHBOARD.PUBLIC.PROJETS.ROOT,
                        },
                        {
                            title: 'Nous Découvrir',
                            description: 'Créez et modifiez la section de présentation de votre groupe',
                            url: RouteNames.DASHBOARD.PUBLIC.HOME.ABOUT,
                        },
                        {
                            title: 'Nos CDs',
                            description: 'Administrez votre catalogue de productions musicales',
                ...
                {
                    title: 'Concerts',
                    description: 'Gérez la programmation et les informations à propos des concerts',
                    url: RouteNames.DASHBOARD.PUBLIC.CONCERTS,
                    items: [
                        {
                            title: 'Prochains Concerts',
                            description: 'Planifiez et publiez vos futurs concerts et représentations',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            title: 'Videos',
                            description: 'L\'ensemble des vidéos mises à disposition depuis Youtube',
        ...
        },
        {
            ...
            items: [
                ...
                {
                    title: 'Travail',
                    description: 'Espace de collaboration et de suivi des partitions, etc...',
    ...
    return (
        <>
            <div
                className={cn("transition-all duration-300", isNavOpen ? "fixed inset-0 bg-black/70 z-40" : "bg-transparent pointer-events-none")}
                onClick={() => setIsNavOpen(false)}
            />

            <div className="sticky top-0 lg:top-4 z-50 bg-white lg:bg-transparent border-b lg:border-none pb-2 lg:pb-0 px-4" >
                <div className={cn("flex items-center justify-between p-0 lg:p-2 mx-auto mt-2 lg:mt-0 rounded-full border border-transparent lg:border-border bg-white/95 container",
                    isNavOpen && "bg-background")}>
                    <div className="flex items-center gap-4">
                        <Link href={RouteNames.DASHBOARD.ROOT} className="hover:opacity-80 transition-all duration-300 hidden lg:block">
                            <Image
                                src="/picto.svg"
                                alt="Logo"
                                width={40}
